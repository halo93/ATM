 ...
 * @author dongh
 */
public class ChangePIN_success extends javax.swing.JFrame {

    /**
     * Creates new form Index
     */
    public ChangePIN_success() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Your PIN changed!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangePIN_success.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangePIN_success().setVisible(true);
            }
        });
    }
